...
ResetContainer.sh
    - a utility for resetting a Predix Machine container to a pre-run state. This will clear generated keystores and password and encrypted fields. 
        It will also remove enrollment information.
