...
GenerateContainers:
    ...
    Requirements: Eclipse and Maven, and Docker if using the Docker option.
        ...
        from artifactory (e.g. predixmachine-openjdk-jre-x86_64-1.3.0.tar.gz) and load it into Docker using -
        docker load -i predixmachine-openjdk-jre-x86_64-1.3.0.tar.gz
